...
The library is described in the paper: [doi:10.1080/10556788.2023.2296978](https://doi.org/10.1080/10556788.2023.2296978)  
An earlier version is available as a technical report: [arXiv:2306.08622](https://doi.org/10.48550/arXiv.2306.08622)
...
To compile the project, follow the instructions in: [Installation](documentation/INSTALL.md)
...
The instance format is described in: [Instance Format](documentation/INSTANCE.md)
...
A complete description of the available options is provided in: [Parameters](documentation/PARAMETERS_TABLE.md)

Command-line keywords for overriding instance data at runtime are described in: [Extras](documentation/EXTRAS.md)

Instructions for using PathWyse from Python are available in: [Python](python/PYTHON.md)

A description of the library components is available in: [Architecture](documentation/architecture.md)
...
Optimization Methods and Software. [doi:10.1080/10556788.2023.2296978](https://doi.org/10.1080/10556788.2023.2296978)
